---
title: Python
description: It allows interaction with the MoneyFusion payment API. It simplifies the creation and retrieval of payments via HTTP requests.
---
...
print(payment)
```
Note: webhook_url must accept POST requests
...
```json
{
  ...
  "url": "https://payin.moneyfusion.net/payment/xxxxxxxx/Marchand"
}
```

### Retrieve a payment

```python title="checkPaymentStatus.py"
