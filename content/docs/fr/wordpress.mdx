---
title: Wordpress
description: Fusion Pay WooCommerce Payment Gateway est un plugin WordPress personnalisé qui vous permet d'intégrer le système de paiement MoneyFusion dans votre site WordPress WooCommerce.
---
...
1. Téléchargez le plugin à partir de [ce lien](https://github.com/Yaya12085/wp-fusionpay/archive/refs/heads/main.zip).
...
4. Si l'option de paiement n'est pas visible, allez sur la page de paiement et entrez `[woocommerce_checkout]` dans la section raccourci pour plus d'informations :
   [![Voir la vidéo](https://img.youtube.com/vi/sfYauEEO7S0/0.jpg)](https://www.youtube.com/watch?v=sfYauEEO7S0)

<Callout title="Bon à savoir">
  Veillez à ce que la devise soit le franc CFA et que le montant soit de 200
  minimum pour que tout fonctionne sans problème.
</Callout>

## Support

Pour toute question ou demande de fonctionnalité, veuillez consulter la page [GitHub Issues Page](https://github.com/Yaya12085/wp-fusionpay/issues)
